<div class="servico">
    ...
    <p><span class="label">Espacio físico: </span><span class="js-editable required" data-edit="acessibilidade" data-emptytext="Seleccione" data-original-title="Espacio físico"><?php echo $entity->acessibilidade; ?></span></p>
    <?php endif; ?>
    ...
    <?php if($this->isEditable()):?>
        ...
        <p><span></span><span class="label">¿El proyecto cultural que se desarrolla en este espacio es de carácter público/gubernamental? </span> <span class="js-editable required js-mask-phone" data-edit="telefone2" data-original-title="¿Proyecto público?" data-emptytext="Seleccione"><?php echo $entity->telefone2; ?></span></p>
    <?php endif; ?>
